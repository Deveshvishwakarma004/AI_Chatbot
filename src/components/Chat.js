...
const Chat = () => {
    ...
    const handleSendRequest = async (e) => {
        ...
        try {
            ...
            setResponse(response.data.result.startsWith('AI') ? response.data.result.substring(3) : response.data.result);
        } catch (error) {
            console.error(error);
        }
    };
        ...
        <div class="flex">
            ...
            <div class="md:w-5/12 lg:inline md:inline hidden h-screen border-r-2 border-r-gray-700">
                <div className='m-5 flex flex-row gap-1'>
                    ...
                    <h2 className='text-3xl'>Your Own GPT-4.AI</h2>
                    <a href="https://github.com/Deveshvishwakarma004" className='ml-auto text-3xl flex justify-end items-center' target='_blank' rel='noreferrer'>
